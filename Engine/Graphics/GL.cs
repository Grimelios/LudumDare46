...
namespace Engine.Graphics
{
	public static class GL
	{
		static GL()
		{
			...
			glUniform1iv = GetDelegate<Delegates.glUniform1iv>();
			glUniform1f = GetDelegate<Delegates.glUniform1f>();
			glUniform1fv = GetDelegate<Delegates.glUniform1fv>();
		...
		public static unsafe class Delegates
		{
			...
			public delegate void glUniform1iv(int location, uint count, int* value);
			public delegate void glUniform1f(int location, float v0);
			public delegate void glUniform1fv(int location, uint count, float* v0);
