...
namespace Engine
{
	public static class Resolution
	{
		...
		public static ivec2 RenderDimensions
		{
			...
			set
			{
				Debug.Assert(value.x > 0, "Render width must be positive.");
				Debug.Assert(value.y > 0, "Render height must be positive.");
		...
		public static ivec2 WindowDimensions
		{
			...
			set
			{
				Debug.Assert(value.x > 0, "Window width must be positive.");
				Debug.Assert(value.y > 0, "Window height must be positive.");
