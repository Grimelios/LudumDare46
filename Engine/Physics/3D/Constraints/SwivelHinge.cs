...
{
    /// <summary>
    /// Constrains two bodies3D with a swivel hinge that allows rotation around two axes, like a laptop monitor hinge that allows flipping the screen. Equivalent to a BallSocket constraint and an AngularSwivelHinge constraint solved together.
    /// </summary>
    ...
    public struct SwivelHingeFunctions : IConstraintFunctions<SwivelHingePrestepData, SwivelHingeProjection, Vector4Wide>
    {
            ...
            ref SwivelHingePrestepData prestep, out SwivelHingeProjection projection)
        {
            ...
            Symmetric4x4Wide inverseEffectiveMass = default;
