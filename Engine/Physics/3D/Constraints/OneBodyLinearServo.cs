...
namespace Engine.Physics._3D.Constraints
{
    ...
    public struct OneBodyLinearServoFunctions : IOneBodyConstraintFunctions<OneBodyLinearServoPrestepData, OneBodyLinearServoProjection, Vector3Wide>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref Vector<int> bodyReferences, int count, float dt, float inverseDt, ref BodyInertias inertia, ref OneBodyLinearServoPrestepData prestep,
            out OneBodyLinearServoProjection projection)
        {
            ...
            bodies3D.GatherPose(ref bodyReferences, count, out var position, out var orientation);
