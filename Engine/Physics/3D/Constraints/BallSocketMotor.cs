...
{
    /// <summary>
    /// Constrains the relative linear velocity between two bodies3D to a target.
    ...
    public struct BallSocketMotorFunctions : IConstraintFunctions<BallSocketMotorPrestepData, BallSocketMotorProjection, Vector3Wide>
    {
        ...
        {
            bodies3D.GatherPose(ref bodyReferences, count, out var offsetFromACenterToBCenter, out var orientationA, out var orientationB);
