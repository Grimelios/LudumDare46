...
namespace Engine.Physics._3D.Constraints
{
    ...
    {
        void Prestep(Bodies3D bodies3D, ref ThreeBodyReferences bodyReferences, int count, float dt, float inverseDt,
        ...
        where TConstraintFunctions : unmanaged, IThreeBodyConstraintFunctions<TPrestepData, TProjection, TAccumulatedImpulse>
    {
        ...
        public unsafe override void Prestep(ref TypeBatch typeBatch, Bodies3D bodies3D, float dt, float inverseDt, int startBundle, int exclusiveEndBundle)
        {
            ...
            for (int i = startBundle; i < exclusiveEndBundle; ++i)
            {
                ...
                bodies3D.GatherInertia(ref references, count, out var inertiaA, out var inertiaB, out var inertiaC);
                function.Prestep(bodies3D, ref references, count, dt, inverseDt, ref inertiaA, ref inertiaB, ref inertiaC, ref prestep, out projection);
            }
        }
        ...
        public unsafe override void WarmStart(ref TypeBatch typeBatch, ref Buffer<BodyVelocity> bodyVelocities, int startBundle, int exclusiveEndBundle)
        {
            ...
            for (int i = startBundle; i < exclusiveEndBundle; ++i)
            {
                ...
                Bodies3D.GatherVelocities(ref bodyVelocities, ref bodyReferences, count, out var wsvA, out var wsvB, out var wsvC);
                function.WarmStart(ref wsvA, ref wsvB, ref wsvC, ref projection, ref accumulatedImpulses);
                Bodies3D.ScatterVelocities(ref wsvA, ref wsvB, ref wsvC, ref bodyVelocities, ref bodyReferences, count);
        ...
        public unsafe override void JacobiWarmStart(ref TypeBatch typeBatch, ref Buffer<BodyVelocity> bodyVelocities, ref FallbackTypeBatchResults jacobiResults, int startBundle, int exclusiveEndBundle)
        {
            ...
            for (int i = startBundle; i < exclusiveEndBundle; ++i)
            {
                ...
                Bodies3D.GatherVelocities(ref bodyVelocities, ref bodyReferences, count, out wsvA, out wsvB, out wsvC);
                function.WarmStart(ref wsvA, ref wsvB, ref wsvC, ref projection, ref accumulatedImpulses);
            }
        }
