...
namespace Engine.Physics._3D.Constraints
{
    ...
    /// <summary>
    /// Constrains points on two bodies3D to be separated by a goal distance.
    /// </summary>
    ...
    {
        public static void GetDistance(Bodies3D bodies3D, ref TwoBodyReferences bodyReferences, int count, in Vector3Wide localOffsetA, in Vector3Wide localOffsetB,
            out Vector3Wide anchorOffsetA, out Vector3Wide anchorOffsetB, out Vector3Wide anchorOffset, out Vector<float> distance)
        {
            bodies3D.GatherPose(ref bodyReferences, count, out var offsetB, out var orientationA, out var orientationB);
        ...
        {
            GetDistance(bodies3D, ref bodyReferences, count, prestep.LocalOffsetA, prestep.LocalOffsetB, out var anchorOffsetA, out var anchorOffsetB, out var anchorOffset, out var distance);
