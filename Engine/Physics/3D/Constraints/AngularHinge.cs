...
{
    /// <summary>
    /// Angular component of a hinge. Constrains the angular degrees of freedom of two bodies3D such that they can only rotate relative to each other around the hinge's axis.
    /// </summary>
