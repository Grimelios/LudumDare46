...
{
    /// <summary>
    /// Constrains the area of a triangle connecting the centers of three bodies3D to match a goal area. 
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref ThreeBodyReferences bodyReferences, int count, float dt, float inverseDt,
        ...
        {
            bodies3D.GatherOffsets(ref bodyReferences, count, out var ab, out var ac);
