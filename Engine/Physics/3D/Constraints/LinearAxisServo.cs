...
using static Engine.Physics._3D.Utility.GatherScatter;
namespace Engine.Physics._3D.Constraints
{
    /// <summary>
    /// Constrains points on two bodies3D to be on a plane defined in the local space of one of the bodies3D.
    /// </summary>
    ...
    public struct LinearAxisServoFunctions : IConstraintFunctions<LinearAxisServoPrestepData, LinearAxisServoProjection, Vector<float>>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ComputeTransforms<TJacobianModifier>(ref TJacobianModifier jacobianModifier, Bodies3D bodies3D, ref TwoBodyReferences bodyReferences, int count,
            ...
            where TJacobianModifier : IJacobianModifier
        {
            ...
            bodies3D.GatherPose(ref bodyReferences, count, out var ab, out var orientationA, out var orientationB);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref TwoBodyReferences bodyReferences, int count, float dt, float inverseDt, ref BodyInertias inertiaA, ref BodyInertias inertiaB,
            ref LinearAxisServoPrestepData prestep, out LinearAxisServoProjection projection)
        {
            ...
            ComputeTransforms(ref modifier, bodies3D, ref bodyReferences, count, prestep.LocalOffsetA, prestep.LocalOffsetB, prestep.LocalPlaneNormal, inertiaA, inertiaB, effectiveMassCFMScale,
