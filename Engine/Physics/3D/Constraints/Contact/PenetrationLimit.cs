...
namespace Engine.Physics._3D.Constraints.Contact
{
    ...
    public static class PenetrationLimit
    {
            ...
            float inverseDt, out PenetrationLimitProjection projection)
        {
            ...
            //where positionA and positionB are the center of mass positions of the bodies3D offsetA and offsetB are world space offsets from the center of mass to the contact,
        ...
        /// <summary>
        /// Transforms an impulse from constraint space to world space, uses it to modify the cached world space velocities of the bodies3D.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
