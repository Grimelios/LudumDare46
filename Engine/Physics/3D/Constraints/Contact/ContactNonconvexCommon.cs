...
namespace Engine.Physics._3D.Constraints.Contact
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref Vector<int> bodyReferences, int count,
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref TwoBodyReferences bodyReferences, int count,
