...
{
    /// <summary>
    /// Constrains two bodies3D to maintain a relative position and orientation. All six degrees of freedom are solved simultaneously.
    /// </summary>
    ...
    public struct WeldFunctions : IConstraintFunctions<WeldPrestepData, WeldProjection, WeldAccumulatedImpulses>
    {
        ...
        {
            bodies3D.GatherPose(ref bodyReferences, count, out var localPositionB, out var orientationA, out var orientationB);
