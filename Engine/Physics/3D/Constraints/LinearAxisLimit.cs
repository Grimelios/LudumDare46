...
{
    /// <summary>
    /// Constrains points on two bodies3D to a range of offsets from each other along a direction.
    /// </summary>
    ...
    public struct LinearAxisLimitFunctions : IConstraintFunctions<LinearAxisLimitPrestepData, LinearAxisServoProjection, Vector<float>>
    {
            ...
            ref LinearAxisLimitPrestepData prestep, out LinearAxisServoProjection projection)
        {
            ...
            LinearAxisServoFunctions.ComputeTransforms(ref modifier, bodies3D, ref bodyReferences, count, prestep.LocalOffsetA, prestep.LocalOffsetB, prestep.LocalPlaneNormal, inertiaA, inertiaB, effectiveMassCFMScale,
