...
namespace Engine.Physics._3D.Constraints
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref Vector<int> bodyReferences, int count, float dt, float inverseDt, ref BodyInertias inertiaA,
            ref OneBodyAngularMotorPrestepData prestep, out OneBodyAngularServoProjection projection)
        {
            bodies3D.GatherOrientation(ref bodyReferences, count, out var orientationA);
