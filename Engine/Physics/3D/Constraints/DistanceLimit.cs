...
namespace Engine.Physics._3D.Constraints
{
    ...
    /// <summary>
    /// Constrains points on two bodies3D to be separated by a distance within a range.
    /// </summary>
    ...
    public struct DistanceLimitFunctions : IConstraintFunctions<DistanceLimitPrestepData, DistanceLimitProjection, Vector<float>>
    {
        ...
        {
            DistanceServoFunctions.GetDistance(bodies3D, ref bodyReferences, count, prestep.LocalOffsetA, prestep.LocalOffsetB,
