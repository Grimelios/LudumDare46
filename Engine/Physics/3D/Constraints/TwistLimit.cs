...
{
    /// <summary>
    /// Constrains two bodies3D' rotations around attached twist axes to a range of permitted twist angles.
    /// </summary>
    ...
    public struct TwistLimitFunctions : IConstraintFunctions<TwistLimitPrestepData, TwistLimitProjection, Vector<float>>
    {
        ...
        {
            TwistServoFunctions.ComputeJacobian(bodies3D, bodyReferences, count, prestep.LocalBasisA, prestep.LocalBasisB,
