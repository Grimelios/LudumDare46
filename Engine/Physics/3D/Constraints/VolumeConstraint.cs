...
{
    /// <summary>
    /// Constrains the volume of a tetrahedron connecting the centers of four bodies3D to match a goal volume. 
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Prestep(Bodies3D bodies3D, ref FourBodyReferences bodyReferences, int count, float dt, float inverseDt,
        ...
        {
            bodies3D.GatherOffsets(ref bodyReferences, count, out var ab, out var ac, out var ad);
