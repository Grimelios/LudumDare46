...
namespace Engine.Physics._3D
{
    public struct BodyLocation
    {
        ...
        public int SetIndex;
        /// <summary>
        /// Index of the body within its owning set. If the body is active (and so the Island index is -1), this is an index into the Bodies3D data arrays. 
    ...
    /// <summary>
    /// Collection of all allocated bodies3D.
    /// </summary>
    public class Bodies3D
    {
        /// <summary>
        ...
        /// <summary>
        /// The set of existing bodies3D. The slot at index 0 contains all active bodies3D. Later slots, if allocated, contain the bodies3D associated with inactive islands.
        ...
        /// <summary>
        /// The world transformed inertias of active bodies3D as of the last update. Note that this is not automatically updated for direct orientation changes or for body memory moves.
        ...
        internal PhysicsShapes3D shapes;
        ...
        /// <summary>
        /// Constructs a new bodies3D collection. Initialize must be called for the instance to be ready for use.
        /// </summary>
        /// <param name="pool">Pool for the collection to pull persistent allocations from.</param>
        /// <param name="shapes">PhysicsShapes3D referenced by the collection's bodies3D.</param>
        /// <param name="broadPhase">Broad phase containing the body collidables.</param>
        /// <param name="initialBodyCapacity">Initial number of bodies3D to allocate space for in the active set.</param>
        ...
        public unsafe Bodies3D(BufferPool pool, PhysicsShapes3D shapes, BroadPhase broadPhase,
        ...
        /// <summary>
        /// Initializes the bodies3D set. Used to complete bidirectional dependencies.
        /// </summary>
        /// <param name="solver">Solver responsible for the constraints connected to the collection's bodies3D.</param>
        /// <param name="awakener">Island awakener to use when bodies3D undergo transitions requiring that they exist in the active set.</param>
        ...
        void RemoveCollidableFromBroadPhase(int activeBodyIndex, ref Collidable collidable)
        {
            ...
            if (broadPhase.RemoveActiveAt(removedBroadPhaseIndex, out var movedLeaf))
            {
                ...
                //All statics and inactive bodies3D exist in the static tree.
        ...
        {
            Debug.Assert(HandleToLocation.Allocated, "The backing memory of the bodies3D set should be initialized before use.");
            ...
            //All new bodies3D are active for simplicity. Someday, it may be worth offering an optimized path for inactives, but it adds complexity.
            //(Directly adding inactive bodies3D can be helpful in some networked open world scenarios.)
        ...
        /// <summary>
        /// Removes a body from the set by its handle. If the body is inactive, all bodies3D in its island will be forced active.
        /// </summary>
        ...
        private struct ConnectedDynamicCounter : IForEach<int>
        {
            ...
            {
                //The solver's connected bodies3D enumeration directly provides the constraint-stored reference, which is an index in the active set for active constraints and a handle for inactive constraints.
                ...
                if (!IsKinematic(bodies3D.ActiveSet.LocalInertias[bodyIndex]))
                    ++DynamicCount;
            }
        }
        ...
        void UpdateForKinematicStateChange(int handle, ref BodyLocation location, ref BodySet set, bool newlyKinematic)
        {
            ...
            if (newlyKinematic)
            {
                ...
                for (int i = 0; i < constraints.Count; ++i)
                {
                    ...
                    {
                        //This constraint connects only kinematic bodies3D; keeping it in the solver would cause a singularity.
        ...
        /// If the body is becoming kinematic, any constraints which only contain kinematic bodies3D will be removed.
        /// Wakes up the body.
        /// </summary>
        ...
        /// If the body is becoming kinematic, any constraints which only contain kinematic bodies3D will be removed. Wakes up the body.
        /// </summary>
        ...
        /// <summary>
        /// Checks whether a body handle is currently registered with the bodies3D set.
        /// </summary>
        ...
        /// <param name="count">Number of bodies3D in the bundle.</param>
        ...
        /// <param name="references">Active body indices being gathered.</param>
        /// <param name="count">Number of body pairs in the bundle.</param>
        /// <param name="orientation">Gathered orientation of bodies3D in the bundle.</param>
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// </summary>
        /// <param name="references">Active set indices of the bodies3D to gather velocity data for.</param>
        /// <param name="count">Number of bodies3D in the bundle.</param>
        ...
        /// <param name="references">Active set indices of the bodies3D to gather velocity data for.</param>
        /// <param name="count">Number of body pairs in the bundle.</param>
        /// <param name="velocitiesA">Gathered velocities of A bodies3D.</param>
        /// <param name="velocitiesB">Gathered velocities of B bodies3D.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="velocitiesA">Gathered velocities of A bodies3D.</param>
        /// <param name="velocitiesB">Gathered velocities of B bodies3D.</param>
        /// <param name="velocitiesC">Gathered velocities of C bodies3D.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="velocitiesB">Gathered velocities of B bodies3D.</param>
        /// <param name="velocitiesC">Gathered velocities of C bodies3D.</param>
        /// <param name="velocitiesD">Gathered velocities of D bodies3D.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <param name="references">Active set indices of the bodies3D to scatter velocity data to.</param>
        /// <param name="count">Number of body pairs in the bundle.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        struct ActiveConstraintBodyHandleEnumerator<TInnerEnumerator> : IForEach<int> where TInnerEnumerator : IForEach<int>
        {
            ...
            public void LoopBody(int connectedBodyIndex)
            {
                if (SourceBodyIndex != connectedBodyIndex)
                {
                    //This enumerator is associated with the public connected bodies3D enumerator function. The user supplies a handle and expects handles in return, so we 
                    //must convert the solver-provided indices to handles.
                    InnerEnumerator.LoopBody(bodies3D.ActiveSet.IndexToHandle[connectedBodyIndex]);
                }
            }

        }
        //Note that inactive constraints reference bodies3D by handles rather than indices.
        ...
        /// <summary>
        /// Enumerates all the bodies3D connected to a given active body.
        /// Bodies3D which are connected by more than one constraint will be reported multiple times.
        /// </summary>
        /// <typeparam name="TEnumerator">Type of the enumerator to execute on each connected body.</typeparam>
        /// <param name="activeBodyIndex">Index of the active body to enumerate the connections of. This body will not appear in the set of enumerated bodies3D, even if it is connected to itself somehow.</param>
        ...
        internal void EnumerateConnectedBodyIndices<TEnumerator>(int activeBodyIndex, ref TEnumerator enumerator) where TEnumerator : IForEach<int>
        {
            ...
            //Note that we have to assume the enumerator contains state mutated by the internal loop bodies3D.
        ...
        /// <summary>
        /// Enumerates all the bodies3D connected to a given body.
        /// Bodies3D which are connected by more than one constraint will be reported multiple times.
        /// </summary>
        /// <typeparam name="TEnumerator">Type of the enumerator to execute on each connected body.</typeparam>
        /// <param name="bodyHandle">Handle of the body to enumerate the connections of. This body will not appear in the set of enumerated bodies3D, even if it is connected to itself somehow.</param>
        /// <param name="enumerator">Enumerator instance to run on each connected body.</param>
        /// <param name="solver">Solver from which to pull constraint body references.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void EnumerateConnectedBodies<TEnumerator>(int bodyHandle, ref TEnumerator enumerator) where TEnumerator : IForEach<int>
        {
            ...
            if (bodyLocation.SetIndex == 0)
            {
                ...
                constraintBodiesEnumerator.bodies3D = this;
        ...
        /// <summary>
        /// Clears all bodies3D from all sets without releasing any memory that wouldn't be released by a sequence of regular removals.
        /// </summary>
        public unsafe void Clear()
        {
            ActiveSet.Clear(Pool);
            //While the top level pool represents active bodies3D and will persist (as it would after a series of removals),
            //subsequent sets represent inactive bodies3D. When they are not present, the backing memory is released.
        ...
        /// <summary>
        /// Resizes all active body constraint lists to meet the MinimumConstraintCapacityPerBody. Inactive bodies3D are untouched.
        ...
        /// <summary>
        /// Ensures all active body constraint lists can hold at least MinimumConstraintCapacityPerBody constraints. Inactive bodies3D are untouched.
        /// </summary>
