namespace Engine.Physics._3D
{
    ...
    {
        /// <summary>
        /// The number of bodies3D to allocate space for.
        /// </summary>
        public int Bodies;
        /// <summary>
        ...
        public int Islands;
        /// <summary>
        /// Minimum number of physicsShapes3D to allocate space for in each shape type batch.
        /// </summary>
        ...
        /// New bodies3D will be given enough memory for this number of constraints, and any compaction will not reduce the allocations below it.
        /// </summary>
