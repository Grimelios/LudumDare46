...
namespace Engine.Physics._3D
{
    ...
    public struct BodyActivity
    {
        ...
        /// <summary>
        /// True if this body is a candidate for being slept. If all the bodies3D that it is connected to by constraints are also candidates, this body may go to sleep.
        /// </summary>
