...
namespace Engine.Physics._3D.Utility
{
    /// <summary>
    ...
    public struct BoundingBox
    {
        ...
        /// </summary>
        /// <param name="boundingSphere">PhysicsSphere to test for intersection.</param>
        /// <returns>Whether the bounding physicsShapes3D intersect.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
