...
namespace Engine.Physics._3D.Utility.Collections
{
    /// <summary>
    ...
    public struct IndexSet
    {
        ...
        /// 16384 bodies3D would only take 2KB. Even if you have 1000 batches all at that size, it's a pretty unconcerning amount of storage.
        ...
        //While we expose a compaction and resize, using it requires care. It would be a mistake to, for example, shrink beyond the current bodies3D indices size.
