...
namespace Engine.Physics._3D
{
    ...
    /// <summary>
    /// Stores a group of bodies3D- either the set of active bodies3D, or the bodies3D involved in an inactive simulation island.
    /// </summary>
    public struct BodySet
    {
        ...
        /// <summary>
        /// Activity states of bodies3D in the set.
        /// </summary>
        ...
        internal int Add(in BodyDescription bodyDescription, int handle, int minimumConstraintCapacity, BufferPool pool)
        {
            ...
            //Collidable's broad phase index is left unset. The Bodies3D collection is responsible for attaching that data.
        ...
        {
            //This uses a linear search. That's fine; bodies3D will rarely have more than a handful of constraints associated with them.
        ...
        /// <summary>
        /// Swaps the memory of two bodies3D. Indexed by memory slot, not by handle index.
        /// </summary>
