...
namespace Engine.Physics._3D
{
    ...
    public struct BodyDescription
    {
        ...
        public static BodyDescription CreateConvexDynamic<TConvexShape>(
            in RigidPose pose, in BodyVelocity velocity, float mass, PhysicsShapes3D shapes, in TConvexShape shape)
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexDynamic<TConvexShape>(
            in Vector3 position, in BodyVelocity velocity, float mass, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexDynamic<TConvexShape>(
            in RigidPose pose, float mass, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexDynamic<TConvexShape>(
            in Vector3 position, float mass, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
        ...
        public static BodyDescription CreateConvexKinematic<TConvexShape>(
            in RigidPose pose, in BodyVelocity velocity, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
            var description = new BodyDescription
            {
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexKinematic<TConvexShape>(
            in Vector3 position, in BodyVelocity velocity, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexKinematic<TConvexShape>(
            in RigidPose pose, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
        ...
        /// <returns>Constructed description for the body.</returns>
        public static BodyDescription CreateConvexKinematic<TConvexShape>(
            in Vector3 position, PhysicsShapes3D shapes, in TConvexShape shape)
            where TConvexShape : unmanaged, IConvexShape
        {
