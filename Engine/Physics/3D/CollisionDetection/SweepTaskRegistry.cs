...
namespace Engine.Physics._3D.CollisionDetection
{
    ...
    {
        /// <summary>
        /// Checks whether a swept test should be performed for children of swept physicsShapes3D.
        /// </summary>
    ...
    public abstract class SweepTask
    {
        ...
        protected abstract unsafe bool PreorderedTypeSweep<TSweepFilter>(
            ...
            bool flipRequired, ref TSweepFilter filter, PhysicsShapes3D shapes, SweepTaskRegistry sweepTasks, BufferPool pool, out float t0, out float t1, out Vector3 hitLocation, out Vector3 hitNormal)
        ...
        public unsafe bool Sweep<TSweepFilter>(
            ...
            float maximumT, float minimumProgression, float convergenceThreshold, int maximumIterationCount,
            ref TSweepFilter filter, PhysicsShapes3D shapes, SweepTaskRegistry sweepTasks, BufferPool pool, out float t0, out float t1, out Vector3 hitLocation, out Vector3 hitNormal)
            where TSweepFilter : ISweepFilter
        {
