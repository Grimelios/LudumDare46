...
namespace Engine.Physics._3D.CollisionDetection
{
    ...
    {
        /// <summary>
        /// General pair for two physicsShapes3D with full pose and flip mask, but no bounds related data.
        /// </summary>
        StandardPair,
        /// <summary>
        /// Pair specialized for convex pairs between two physicsShapes3D of the same type.
        /// </summary>
        FliplessPair,
        /// <summary>
