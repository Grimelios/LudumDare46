...
namespace Engine.Physics._3D.CollisionDetection.SweepTasks
{
    public struct CapsuleBoxDistanceTester : IPairDistanceTester<CapsuleWide, BoxWide>
    {
            ...
            out Vector<float> depth, out Vector3Wide normal, out Vector3Wide closestA)
        {
            ...
            //PhysicsBox edge - capsule endpoints: handled by capsule endpoint clamping 
            //PhysicsBox edge - capsule axis: handled explicitly by the edge cases
            //PhysicsBox face - capsule endpoints: handled by capsule endpoint clamping
            //PhysicsBox face - capsule axis: redundant with edge-axis or face-endpoint
            //PhysicsBox vertex - capsule endpoints: handled by capsule endpoint clamping
            //PhysicsBox vertex - capsule axis: unhandled
