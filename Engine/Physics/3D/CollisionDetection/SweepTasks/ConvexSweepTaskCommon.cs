...
namespace Engine.Physics._3D.CollisionDetection.SweepTasks
{
            ...
            where TPairDistanceTester : struct, IPairDistanceTester<TShapeWideA, TShapeWideB>
    {
        ...
        protected override unsafe bool PreorderedTypeSweep<TSweepFilter>(
            ...
            float minimumProgression, float convergenceThreshold, int maximumIterationCount,
            bool requiresFlip, ref TSweepFilter filter, PhysicsShapes3D shapes, SweepTaskRegistry sweepTasks, BufferPool pool, out float t0, out float t1, out Vector3 hitLocation, out Vector3 hitNormal)
        {
            ...
            where TSweepModifier : struct, ISweepModifier
        {
            ...
            //Initialize the interval to the tighter of 1) input bounds [0, maximumT] and 2) the swept impact interval of the bounding spheres of the two physicsShapes3D.
            ...
            //We now have a relatively tight bracket (not much larger than the involved physicsShapes3D, at least).
            ...
            samples = default;
            sampleOffsetB = default;
            sampleOrientationA = default;
            sampleOrientationB = default;
            ...
            while (true)
            {
                ...
                //For example, if both physicsShapes3D were rotating fast enough that they reached maximum angular expansion:
