...
namespace Engine.Physics._3D.CollisionDetection.SweepTasks
{
        ...
        where TSupportFinderB : struct, ISupportFinder<TShapeB, TShapeWideB>
    {
            ...
            out Vector<int> intersected, out Vector<float> distance, out Vector3Wide closestA, out Vector3Wide normal)
        {
            ...
            //Use the JIT's ability to optimize away branches with generic type knowledge to set appropriate containment epsilons for physicsShapes3D that have actual margins.
            ...
            //The containment epsilon acts as a margin around physicsShapes3D that guarantees that normals remain numerically valid.
            ...
            //In other words, the physicsShapes3D are spherically expanded a little. Not ideal for physicsShapes3D that don't actually have margins, but not horrible.
            distance -= containmentEpsilon;
            Vector3Wide.Scale(normal, inverseDistance, out normal);

            //For physicsShapes3D with substantial margins, it's important to compensate for the margin.
