...
namespace Engine.Physics._3D.CollisionDetection
{
        ...
        where TAccumulatedImpulses : unmanaged, IConvexContactAccumulatedImpulses<TAccumulatedImpulses>
    {
        ...
        public override void ExtractContactData<TExtractor>(in ConstraintLocation constraintLocation, Solver solver, ref TExtractor extractor)
        {
            ...
            var bodyHandle = constraintLocation.SetIndex == 0 ? solver.bodies3D.ActiveSet.IndexToHandle[bodyReference] : bodyReference;
        ...
        where TAccumulatedImpulses : unmanaged, IConvexContactAccumulatedImpulses<TAccumulatedImpulses>
    {
        ...
        public override void ExtractContactData<TExtractor>(in ConstraintLocation constraintLocation, Solver solver, ref TExtractor extractor)
        {
            ...
            {
                bodyHandleA = solver.bodies3D.ActiveSet.IndexToHandle[bodyReferences.IndexA[0]];
                bodyHandleB = solver.bodies3D.ActiveSet.IndexToHandle[bodyReferences.IndexB[0]];
            }
            else
            {
