    ...
    public partial class NarrowPhase<TCallbacks>
    {
        public struct PendingConstraintAddCache
        {
                ...
                where TDescription : struct, IConstraintDescription<TDescription>
            {
                ...
                ref var aLocation = ref simulation.Bodies3D.HandleToLocation[handles];
                ...
                simulation.Bodies3D.AddConstraint(aLocation.Index, constraintHandle, 0);
                if (typeof(TBodyHandles) == typeof(TwoBodyHandles))
                {
                    ref var bLocation = ref simulation.Bodies3D.HandleToLocation[Unsafe.Add(ref handles, 1)];
                    ...
                    simulation.Bodies3D.AddConstraint(bLocation.Index, constraintHandle, 1);
                }
