...
{
    using DepthRefiner = DepthRefiner<PhysicsCylinder, CylinderWide, CylinderSupportFinder, PhysicsCylinder, CylinderWide, CylinderSupportFinder>;
    ...
    public struct CylinderPairTester : IPairTester<CylinderWide, CylinderWide, Convex4ContactManifoldWide>
    {
            ...
            out Convex4ContactManifoldWide manifold)
        {
            ...
            //PhysicsCylinder-sphere was easy, cylinder-capsule was a bit complicated, and things go downhill from there.
            ...
            //PhysicsCylinder-cylinder has to handle the intersecting case accurately, which means you're stuck (conceptually) enumerating 4 or 8 roots per feature pair.
            //There are some pretty fast solvers around, but it's hard to avoid quite a few square roots given the physicsShapes3D involved.
