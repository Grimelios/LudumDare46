...
namespace Engine.Physics._3D.CollisionDetection.CollisionTasks
{
    public struct CapsuleTriangleTester : IPairTester<CapsuleWide, TriangleWide, Convex2ContactManifoldWide>
    {
            ...
            out Convex2ContactManifoldWide manifold)
        {
            ...
            //PhysicsCapsule3D endpoint vs face (redundant with AC x AB)
            //PhysicsCapsule3D endpoint vs edge
            //PhysicsCapsule3D endpoint vs vertex
            //PhysicsCapsule3D line vs face (redundant with either axis-edge or endpoint vs face)
            //PhysicsCapsule3D line vs edge (redundant with axis-edge)
            //PhysicsCapsule3D line vs vertex
