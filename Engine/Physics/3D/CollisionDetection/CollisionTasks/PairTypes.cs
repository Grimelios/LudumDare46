...
namespace Engine.Physics._3D.CollisionDetection.CollisionTasks
{
    ...
    {
        public PhysicsSphere A;
        public PhysicsSphere B;
        public Vector3 OffsetB;
        public float SpeculativeMargin;
        public PairContinuation Continuation;
    ...
    public struct SphereIncludingPairWide<TShape, TShapeWide> : ICollisionPairWide<PhysicsSphere, SphereWide, TShape, TShapeWide, SphereIncludingPair, SphereIncludingPairWide<TShape, TShapeWide>>
        where TShape : struct, IConvexShape where TShapeWide : struct, IShapeWide<TShape>
    {
        public SphereWide A;
        public TShapeWide B;
        ...
        public bool HasFlipMask
        {
            //Because the physicsShapes3D are guaranteed to be distinct (one is apparently a sphere and the other isn't), there will always be a flip mask.
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get { return true; }
        }
    ...
    public struct SpherePairWide : ICollisionPairWide<PhysicsSphere, SphereWide, PhysicsSphere, SphereWide, SpherePair, SpherePairWide>
    {
        public SphereWide A;
        public SphereWide B;
        public Vector3Wide OffsetB;
