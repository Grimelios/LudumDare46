...
namespace Engine.Physics._3D.CollisionDetection.CollisionTasks
{
        ...
        where TCompoundB : ICompoundShape
    {
            ...
            where TCallbacks : struct, ICollisionCallbacks
        {
            ...
            collisionBatcher.PhysicsShapes3D[childTypeA].GetShapeData(compoundChildA.ShapeIndex.Index, out childShapeDataA, out _);
        }
            ...
            where TCallbacks : struct, ICollisionCallbacks
        {
            ...
            collisionBatcher.PhysicsShapes3D[childTypeB].GetShapeData(compoundChildB.ShapeIndex.Index, out childShapeDataB, out _);
