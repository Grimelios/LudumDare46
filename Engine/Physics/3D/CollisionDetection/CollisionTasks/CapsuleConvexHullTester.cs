...
namespace Engine.Physics._3D.CollisionDetection.CollisionTasks
{
    public struct CapsuleConvexHullTester : IPairTester<CapsuleWide, ConvexHullWide, Convex2ContactManifoldWide>
    {
        ...
        public void Test(ref CapsuleWide a, ref ConvexHullWide b, ref Vector<float> speculativeMargin, ref Vector3Wide offsetB, ref QuaternionWide orientationA, ref QuaternionWide orientationB, int pairCount, out Convex2ContactManifoldWide manifold)
        {
            ...
            DepthRefiner<ConvexHull, ConvexHullWide, ConvexHullSupportFinder, PhysicsCapsule3D, CapsuleWide, CapsuleSupportFinder>.FindMinimumDepth(
            ...
            //(PhysicsCapsule3D vs hull surface doesn't really matter, but we choose hull because we may later build a system similar to MeshReduction that relies on contacts being on the hull surface.)
