...
namespace Engine.Physics._3D.CollisionDetection.CollisionTasks
{
    public struct TrianglePairTester : IPairTester<TriangleWide, TriangleWide, Convex4ContactManifoldWide>
    {
            ...
            out Convex4ContactManifoldWide manifold)
        {
            ...
            //Create a scale-sensitive epsilon for comparisons based on the size of the involved physicsShapes3D. This helps avoid varying behavior based on how large involved objects are.
