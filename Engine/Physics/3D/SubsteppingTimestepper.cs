...
namespace Engine.Physics._3D
{
    ...
    public class SubsteppingTimestepper : ITimestepper
    {
        ...
        /// <summary>
        /// Fires after the sleeper completes and before bodies3D are integrated.
        /// </summary>
        public event TimestepperStageHandler Slept;
        /// <summary>
        /// Fires after bodies3D have their bounding boxes updated for the frame's predicted motion and before collision detection.
        /// </summary>
        ...
        /// <summary>
        /// Fires after bodies3D have their velocities integrated and before the solver executes.
        /// </summary>
        ...
        /// <summary>
        /// Fires after bodies3D have their poses integrated and before the substep ends.
        /// </summary>
