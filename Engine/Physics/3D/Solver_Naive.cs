...
//                    TypeProcessors[typeBatch.TypeId].Prestep(ref typeBatch, bodies3D, context.Dt, inverseDt, block.StartBundle, block.End);
//                else
//                    TypeProcessors[typeBatch.TypeId].JacobiPrestep(ref typeBatch, bodies3D, ref ActiveSet.Fallback, context.Dt, inverseDt, block.StartBundle, block.End);
//            }
//        }
...
//                if (block.BatchIndex < FallbackBatchThreshold)
//                {
//                    TypeProcessors[typeBatch.TypeId].JacobiWarmStart(ref typeBatch, ref bodies3D.ActiveSet.Velocities, ref context.FallbackResults[block.TypeBatchIndex], block.StartBundle, block.End);
//                }
//                else
//                {
//                    TypeProcessors[typeBatch.TypeId].WarmStart(ref typeBatch, ref bodies3D.ActiveSet.Velocities, block.StartBundle, block.End);
//                }
//            }
//        }
...
//                if (block.BatchIndex < FallbackBatchThreshold)
//                {
//                    TypeProcessors[typeBatch.TypeId].SolveIteration(ref typeBatch, ref bodies3D.ActiveSet.Velocities, block.StartBundle, block.End);
//                }
//                else
//                {
//                    TypeProcessors[typeBatch.TypeId].JacobiSolveIteration(ref typeBatch, ref bodies3D.ActiveSet.Velocities, ref context.FallbackResults[block.TypeBatchIndex], block.StartBundle, block.End);
//                }
//            }
//        }
