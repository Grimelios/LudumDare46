...
namespace Engine.Physics._3D
{
    public static class BoundingBoxHelpers
    {
        ...
        /// </summary>
        public static unsafe void GetLocalBoundingBoxForSweep(TypedIndex shapeIndex, PhysicsShapes3D shapes, in RigidPose localPoseA, in Quaternion orientationA, in BodyVelocity velocityA,
