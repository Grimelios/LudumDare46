...
namespace Engine.Physics._3D.Collidables
{
    ...
    /// </summary>
    public struct PhysicsCylinder : IConvexShape
    {
        /// <summary>
        ...
        {
            return new ConvexShapeBatch<PhysicsCylinder, CylinderWide>(pool, initialCapacity);
        }

        /// <summary>
        /// Type id of cylinder physicsShapes3D.
        /// </summary>
        public const int Id = 4;
        public int TypeId { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Id; } }
    }

    public struct CylinderWide : IShapeWide<PhysicsCylinder>
    {
        public Vector<float> Radius;
        public Vector<float> HalfLength;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Broadcast(in PhysicsCylinder shape)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteFirst(in PhysicsCylinder source)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSlot(int index, in PhysicsCylinder source)
        {
    ...
    public struct CylinderSupportFinder : ISupportFinder<PhysicsCylinder, CylinderWide>
    {
