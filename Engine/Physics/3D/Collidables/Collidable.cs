...
namespace Engine.Physics._3D.Collidables
{
    ...
    public struct Collidable
    {
        ...
        /// If you need to perform such a transition, consider using Bodies3D.ChangeShape or Bodies3D.ApplyDescription; those functions update the relevant state.
        /// </summary>
        ...
        /// would push the physicsShapes3D of a pair into overlap. This should be positive to avoid jittering. It can also be used as a form of continuous collision detection, but excessively 
