...
namespace Engine.Physics._3D.Collidables
{
    ...
    /// </summary>
    public struct PhysicsCapsule3D : IConvexShape
    {
        /// <summary>
        ...
        public PhysicsCapsule3D(float radius, float length)
        {
            Radius = radius;
        ...
        public ShapeBatch CreateShapeBatch(BufferPool pool, int initialCapacity, PhysicsShapes3D physicsShape3DBatches)
        {
            return new ConvexShapeBatch<PhysicsCapsule3D, CapsuleWide>(pool, initialCapacity);
        }



        /// <summary>
        /// Type id of capsule physicsShapes3D.
        /// </summary>
        public const int Id = 1;
        public int TypeId { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Id; } }
    }

    public struct CapsuleWide : IShapeWide<PhysicsCapsule3D>
    {
        public Vector<float> Radius;
        public Vector<float> HalfLength;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Broadcast(in PhysicsCapsule3D shape)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteFirst(in PhysicsCapsule3D source)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSlot(int index, in PhysicsCapsule3D source)
        {
    ...
    public struct CapsuleSupportFinder : ISupportFinder<PhysicsCapsule3D, CapsuleWide>
    {
