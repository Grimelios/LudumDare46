...
{
    /// <summary>
    /// Reusable convenience type for incrementally building compound physicsShapes3D.
    /// </summary>
    public struct CompoundBuilder : IDisposable
    {
        ...
        /// <summary>
        /// Adds a new shape to the accumulator, creating a new shape in the physicsShapes3D set. The mass used to compute the inertia tensor will be based on the given weight.
        /// </summary>
        /// <typeparam name="TShape">Type of the shape to add to the accumulator and the physicsShapes3D set.</typeparam>
        ...
        public void Add<TShape>(in TShape shape, in RigidPose localPose, float weight) where TShape : unmanaged, IConvexShape
        {
            ...
            child.ShapeIndex = physicsShapes3D.Add(shape);
            child.Weight = weight;
        ...
        /// <summary>
        /// Adds a new shape to the accumulator, creating a new shape in the physicsShapes3D set. Inertia is assumed to be infinite.
        /// </summary>
        /// <typeparam name="TShape">Type of the shape to add to the accumulator and the physicsShapes3D set.</typeparam>
        /// <param name="shape">Shape to add.</param>
        /// <param name="localPose">Pose of the shape in the compound's local space.</param>
        ...
        {
            Debug.Assert(Compound.ValidateChildIndex(shape, physicsShapes3D));
            ref var child = ref Children.Allocate(Pool);
            child.LocalPose = localPose;
        ...
        /// Computes a center of mass and recenters child physicsShapes3D relative to it. Does not reset the accumulator.
        /// </summary>
