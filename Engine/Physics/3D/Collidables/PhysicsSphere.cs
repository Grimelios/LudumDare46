...
namespace Engine.Physics._3D.Collidables
{
    ...
    public struct PhysicsSphere : IConvexShape
    {
        /// <summary>
        ...
        {
            return new ConvexShapeBatch<PhysicsSphere, SphereWide>(pool, initialCapacity);
        }


        /// <summary>
        /// Type id of sphere physicsShapes3D.
        /// </summary>
        public const int Id = 0;
        public int TypeId { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Id; } }
    }

    public struct SphereWide : IShapeWide<PhysicsSphere>
    {
        public Vector<float> Radius;


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Broadcast(in PhysicsSphere shape)
        {
            Radius = new Vector<float>(shape.Radius);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteFirst(in PhysicsSphere source)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSlot(int index, in PhysicsSphere source)
        {
    ...
    public struct SphereSupportFinder : ISupportFinder<PhysicsSphere, SphereWide>
    {
