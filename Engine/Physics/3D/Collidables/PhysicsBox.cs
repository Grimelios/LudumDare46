...
namespace Engine.Physics._3D.Collidables
{
    ...
    /// </summary>
    public struct PhysicsBox : IConvexShape
    {
        /// <summary>
        ...
        public PhysicsBox(float width, float height, float length)
        {
        ...
        {
            return new ConvexShapeBatch<PhysicsBox, BoxWide>(pool, initialCapacity);
        }

        /// <summary>
        /// Type id of box physicsShapes3D.
        /// </summary>
    ...
    public struct BoxWide : IShapeWide<PhysicsBox>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Broadcast(in PhysicsBox shape)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteFirst(in PhysicsBox source)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void WriteSlot(int index, in PhysicsBox source)
        {
    ...
    public struct BoxSupportFinder : ISupportFinder<PhysicsBox, BoxWide>
    {
