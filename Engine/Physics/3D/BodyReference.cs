...
namespace Engine.Physics._3D
{
    ...
    /// </summary>
    /// <remarks>Note that this type makes no attempt to protect against unsafe modification of body properties, nor does modifying its properties try to wake up bodies3D if they are asleep.</remarks>
    public struct BodyReference
    {
        ...
        public int Handle;
        /// <summary>
        /// The bodies3D collection containing the body.
        /// </summary>
        ...
        public bool Exists
        {
            get
            {
                if (bodies3D == null)
                    return false;
                return bodies3D.BodyExists(Handle);
            }
        }
        ...
        public ref BodyLocation Location
        {
            ...
            get
            {
                bodies3D.ValidateExistingHandle(Handle);
                return ref bodies3D.HandleToLocation[Handle];
            }
        }

        /// <summary>
        /// Gets or sets whether the body is in the active set. Setting this to true will attempt to wake the body; setting it to false will force the body and any constraint-connected bodies3D asleep.
        /// </summary>
        public bool Awake
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            ...
            set
            {
                if (Awake)
                {
                    if (!value)
                    {
                        bodies3D.sleeper.Sleep(Location.Index);
                    }
                }
                else
                {
                    if (value)
                    {
                        bodies3D.awakener.AwakenBody(Handle);
                    }
                }
            }
        }
        ...
        public ref BodyVelocity Velocity
        {
            ...
            get
            {
                ...
                return ref bodies3D.Sets[location.SetIndex].Velocities[location.Index];
            }
        }
        ...
        public ref RigidPose Pose
        {
            ...
            {
                ref var location = ref Location;
                return ref bodies3D.Sets[location.SetIndex].Poses[location.Index];
            }
        }
        ...
        public ref Collidable Collidable
        {
            ...
            {
                ref var location = ref Location;
                return ref bodies3D.Sets[location.SetIndex].Collidables[location.Index];
            }
        }
        ...
        public ref BodyInertia LocalInertia
        {
            ...
            {
                ref var location = ref Location;
                return ref bodies3D.Sets[location.SetIndex].LocalInertias[location.Index];
            }
        }
        ...
        public ref BodyActivity Activity
        {
            ...
            {
                ref var location = ref Location;
                return ref bodies3D.Sets[location.SetIndex].Activity[location.Index];
            }
        }
        ...
        public ref QuickList<BodyConstraintReference> Constraints
        {
            ...
            {
                ref var location = ref Location;
                return ref bodies3D.Sets[location.SetIndex].Constraints[location.Index];
            }
        }
        ...
        /// </summary>
        public bool Kinematic { get { return Bodies3D.IsKinematic(LocalInertia); } }

        /// <summary>
        /// Gets whether the body has locked inertia, meaning its inverse inertia tensor is zero.
        /// </summary>
        public bool HasLockedInertia { get { return Bodies3D.HasLockedInertia(LocalInertia.InverseInertiaTensor); } }
        ...
        public void BecomeKinematic()
        {
            if (!Kinematic)
            {
                bodies3D.SetLocalInertia(Handle, default);
            }
        }
        ...
        {
            bodies3D.SetLocalInertia(Handle, localInertia);
        }
        ...
        {
            ref var location = ref Location;
            ref var set = ref bodies3D.Sets[Location.SetIndex];
        ...
        {
            bodies3D.GetDescription(Handle, out description);
        }
        ...
        {
            bodies3D.ApplyDescription(Handle, description);
        }
        ...
        {
            bodies3D.SetShape(Handle, newShape);
        }
        ...
        {
            ref var location = ref Location;
            ref var collidable = ref bodies3D.Sets[location.SetIndex].Collidables[location.Index];
            if (collidable.Shape.Exists)
            {
                if (location.SetIndex == 0)
                {
                    bodies3D.broadPhase.GetActiveBoundsPointers(collidable.BroadPhaseIndex, out min, out max);
                }
                else
                {
                    bodies3D.broadPhase.GetStaticBoundsPointers(collidable.BroadPhaseIndex, out min, out max);
                }
                return true;
            }
            else
        ...
        {
            ref var location = ref Location;
            ApplyImpulse(bodies3D.Sets[location.SetIndex], location.Index, impulse, impulseOffset);
        }
