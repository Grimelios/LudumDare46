...
namespace Engine.Physics._3D
{
    ...
    public class Statics
    {
        ...
        /// <summary>
        /// Removes a static from the set by index. Any inactive bodies3D with bounding boxes overlapping the removed static's bounding box will be forced active.
        /// </summary>
        ...
        public void RemoveAt(int index)
        {
            ...
            if (broadPhase.RemoveStaticAt(removedBroadPhaseIndex, out var movedLeaf))
            {
                ...
                else
                {
                    ...
                    bodies3D.UpdateCollidableBroadPhaseIndex(movedLeaf.Handle, removedBroadPhaseIndex);
                }
            }
        ...
        /// <summary>
        /// Removes a static from the set. Any inactive bodies3D with bounding boxes overlapping the removed static's bounding box will be forced active.
        /// </summary>
        ...
        /// <summary>
        /// Adds a new static body to the simulation. All inactive bodies3D whose bounding boxes overlap the new static are forced active.
        /// </summary>
        ...
        public int Add(in StaticDescription description)
        {
            ...
            {
                Debug.Assert(HandleToIndex.Allocated, "The backing memory of the bodies3D set should be initialized before use. Did you dispose and then not call EnsureCapacity/Resize?");
        ...
        /// <summary>
        /// Applies a new description to an existing static object. All inactive bodies3D with bounding boxes overlapping the old or new static collidable are forced active.
        /// </summary>
        ...
        public unsafe void ApplyDescription(int handle, in StaticDescription description)
        {
            ...
            //Wake all bodies3D up in the old bounds AND the new bounds. Inactive bodies3D that may have been resting on the old static need to be aware of the new environment.
        ...
        /// <summary>
        /// Clears all bodies3D from the set without returning any memory to the pool.
        /// </summary>
